Feature: ServerRetrieve
	In order to ensure devices can synchronise data
	I want to make events from the server available for synchronisation with devices

@mytag
Scenario: Retrieving a commit and deserialising its events
	Given I have created a new event session
	Given I have created an event in the session with an id of E261A67D-2C00-4854-A0FF-6DEFA84A4276 for the stream identified as 1157AC59-AD0D-4BF0-9CC1-238BDE2CEFB9
